        ...
        switch (view.getId()) {
            case R.id.btn_add:
                ...
                if (!TextUtils.isEmpty(description) && maaltid < 5) {
                    ...
                    Meal createdMeal = mMealDao.createMeal(4, "Mellemmåltid:" + description.toString());
                    ...
                    Meal createdMeal = mMealDao.updateMeal(maaltid, 4, "Mellemmåltid:" + description.toString());
